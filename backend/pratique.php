<?php
    ...
    function Sport_Calorie_week($conn){
        ...
        $sql="SELECT sport.nb_calories*pratique.temps/60 FROM pratique 
        LEFT JOIN sport ON sport.id_sport=pratique.id_sport 
        WHERE pratique.login = '".$_GET['login']."'  AND pratique.date <= '".$date_ajd."' AND pratique.date >= '".$date_db_semaine."'";
    ...
    function Sport_Calorie_month($conn){
        ...
        $sql="SELECT sport.nb_calories*pratique.temps/60 FROM pratique 
        LEFT JOIN sport ON sport.id_sport=pratique.id_sport 
        WHERE pratique.login = '".$_GET['login']."'  AND pratique.date <= '".$date_ajd."' AND pratique.date >= '".$date_db_month."'";
